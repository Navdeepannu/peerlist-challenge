      ...
      {dimensions.width > 0 && dimensions.height > 0 && (
        ...
        >
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(140deg, oklch(37% 0.013 285.805) 0%, oklch(70.5% 0.015 286.067) 50%, oklch(37% 0.013 285.805) 100%) border-box",
              WebkitMask:
          ...
          >
            <Pointer className={cn("size-3 text-blue-500", pointerClassName)} />
          </motion.div>
        </motion.div>
      )}
    </div>
